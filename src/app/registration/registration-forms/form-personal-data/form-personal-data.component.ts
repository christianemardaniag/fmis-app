...
@Component({
  ...
  styleUrls: ['./form-personal-data.component.css'],
...
export class FormPersonalDataComponent implements OnInit {
  ...
  sameAsResident() {
    ...
    if(this.sameAsResidentFlag) {
        let residentHouse = this.mainForm.form.value.address.resident.residentHouseNo;
        let residentStreet = this.mainForm.form.value.address.resident.residentStreet;
        let residentSubdivision = this.mainForm.form.value.address.resident.residentSubdivision;
        let residentCity = this.mainForm.form.value.address.resident.residentCityProvince;
        let residentMunicipality = this.mainForm.form.value.address.resident.residentMunicipality;
        let residentZipCode = this.mainForm.form.value.address.resident.residentZipCode;
  ...
  submit() {
    set(ref(this.db, 'users'), this.mainForm.value);
  }
